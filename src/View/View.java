...
public class View
{
    ...
    private void printOptions()
    {
        ...
        System.out.println("6.Print movies which contain a string");
        ...
        while(option != 0)
        {
            ...
            try
            {
                ...
                else if(option == 4)
                {
                    ...
                    ctrl.deleteMovie(readLong());
                }
                else if (option == 11) {

                    ctrl.deleteClient(readLong());
                }
                else if (option == 12) {

                    ctrl.deleteRental(readLong());
                }
                else {
